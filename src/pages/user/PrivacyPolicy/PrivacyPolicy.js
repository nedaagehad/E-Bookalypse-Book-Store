    ...
    return (
        <div className='container-fluid'>
            <div className='container'>
                ...
                <p>
                    E-Poets Society knows that you care how information about you is used and shared, and we appreciate your trust that we will do so carefully and wisely.
                    This Privacy Policy explains how E-Poets Society,
                    as data controller, collects, uses and shares personal information in association with the services we provide through our Platform,
                    including the E-Poets Society e-Reading service and the account you use to access our Services. By visiting and using e-poetssociety.com,
                    you are accepting the practices described in this Privacy Policy.

                    WHEN DO WE COLLECT YOUR PERSONAL DATA?
                    We collect, process and use your personal information when you register for an E-Poets Society account or log into an existing account;
                    order products or digital content from us; access the E-Poets Society Platform or use the E-Poets Society Services; or contact us for customer care.
                    ...
                    We collect your personal information to create and manage your E-Poets Society Account; monitor and manage your purchase transactions;
                    comply with legal and regulatory requirements and with the competent judicial authorities in each geographical jurisdiction that E-Poets Society operates in; maintain,
                    ...
                    Any fraudulent misuse of your E-Poets Society Account or Platform may result in the suspension or cancellation of your Account.
                    ...
                    products, and other information that might be of interest to you when using services from E-Poets Society and/or our affiliates and partners; to offer you more personalized offers and/or special offers,
                    discounts and other information, E-Poets Society may send you discounts, promotion codes, and general information about our society.
                    ...
                    We work to protect the security of your information during transmission by using Secure Sockets Layer (SSL) software, which encrypts information you input. We reveal only the last four digits of your credit card numbers when confirming an order.
                    Of course, we transmit the entire credit card number to the appropriate credit card company during order processing. It is important for you to protect against unauthorized access to your password and to your computer.

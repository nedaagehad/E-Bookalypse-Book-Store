        ...
        <div className={`container-fluid content p-3 ${theme === "night" ? "bg-dark" : ""}`}>
            <div className={`container p-5`}>
                ...
                <div className={theme === "night" ? "text-light" : ""}>
                    ...
                    <p>
                        If you have any concerns about the information and the points listed in our Terms of Use, please <Link to='/contactus' className={`text-decoration-underlined fw-bold ${theme === "night" ? navbar.navItemNight : navbar.navItem}`}>Contact Us</Link>
                    </p>
                </div>
            </div>
        </div>

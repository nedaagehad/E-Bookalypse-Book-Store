                  ...
                  <div className="card-body py-0 px-0 px-sm-3">
                    <div className="row align-items-center">
                      ...
                      <div className="col-5 col-sm-7 col-xl-8 p-0 mt-5 mb-5">
                        <h4 className="mb-1 mb-sm-0 m-2 h2 text-white font-weight-bold">Welcome Back, Hussein🚀</h4>
                    ...
                    <div className="row">
                      <div className="col-9">
                        <div className="d-flex align-items-center align-self-start">
                          ...
                          <p className="text-success ml-2 mb-0 font-weight-bold fs-2">+500</p>
                        </div>
                      </div>
                      <div className="col-3">
                    ...
                    <div className="row">
                      <div className="col-9">
                        <div className="d-flex align-items-center align-self-start">
                          ...
                          <p className="text-success ml-2 mb-0 font-weight-bold fs-2">+400</p>
                        </div>
                      </div>
                      <div className="col-3">
                        <div className="icon icon-box-success">
                    ...
                    <div className="row">
                      <div className="col-9">
                        <div className="d-flex align-items-center align-self-start">
                          ...
                          <p className="text-success ml-2 mb-0 font-weight-bold fs-2">+10</p>
                        </div>
                      </div>
                      <div className="col-3">
                        <div className="icon icon-box-success">
                    ...
                    <div className="row">
                      <div className="col-9">
                        <div className="d-flex align-items-center align-self-start">
                          ...
                          <p className="text-success ml-2 mb-0 font-weight-bold fs-2">+200</p>
                        </div>
                      </div>
                      <div className="col-3">
                        <div className="icon icon-box-success ">
